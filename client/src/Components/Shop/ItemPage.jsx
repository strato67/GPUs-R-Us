        ...
        <div className=" bg-base-200">
          <div className="flex flex-col md:flex-row pb-4 px-4 lg:space-x-6 justify-center md:py-12 ">
            ...
            <div className="flex flex-col justify-center w-fit md:px-4 lg:w-96 md:py-8">
              <h1 className="text-3xl hidden md:inline">{itemInfo.product.name}</h1>
          ...
          <div className="flex flex-col pb-4 px-4 justify-center ">
            <div className="join join-vertical  ">
              <details className="collapse bg-base-200 collapse-plus">

export default function About() {
  return (
    <>
      <div className=" mx-auto bg-white  shadow-md overflow-hidden md:max-w-fit">
        <div className="md:flex">
          <div className="md:shrink-0">
            <img
              className="w-full object-cover md:h-full md:w-96 lg:w-80 xl:w-fit"
              src="https://images.pexels.com/photos/3165335/pexels-photo-3165335.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
              alt="Gaming Photo"
            />
          </div>
          <div className="p-16">
            <div className="uppercase tracking-wide text-3xl text-base-100 font-semibold">
              About Us
            </div>
            <p
            ...
            <p className="mt-2 text-slate-500 py-6">
